...
-- \   \   \/     Version: P.58f
--  \   \         Application: netgen
--  /   /         Filename: MOORE_timesim.vhd
-- /___/   /\     Timestamp: Mon Sep 24 15:51:26 2018
-- \   \  /  \ 
--  \___\/\___\
--             
-- Command	: -intstyle ise -s 5 -pcf MOORE.pcf -rpw 100 -tpw 0 -ar Structure -tm MOORE -insert_pp_buffers true -w -dir netgen/par -ofmt vhdl -sim MOORE.ncd MOORE_timesim.vhd 
-- Device	: 3s1200efg320-5 (PRODUCTION 1.27 2013-03-26)
-- Input file	: MOORE.ncd
-- Output file	: C:\Users\Samuel\Desktop\Practicas_FPGa_nexys2\moore\netgen\par\MOORE_timesim.vhd
-- # of Entities	: 1
-- Design Name	: MOORE
...
begin
  ...
  NlwBlock_MOORE_GND : X_ZERO
    port map (
      O => GND
    );
  NlwBlock_MOORE_VCC : X_ONE
    port map (
      O => VCC
    );
  NlwBlockROC : X_ROC
